module.exports = function(app){
	...
	var RefController = {
		...
		var mailOptions = {
		    ...
		    html: "<h2> Finalize o pagamento </h2><form method=\"post\" action=\"https://checkout.sandbox.tray.com.br/payment/transaction\"><input type=\"hidden\" name=\"token_account\" value=\"7fe49d0444e9ba9\"><input type=\"hidden\" name=\"transaction_product[][description]\" value=\"Cadastro DirectMed\"><input type=\"hidden\" name=\"transaction_product[][quantity]\" value=\"1\"><input type=\"hidden\" name=\"transaction_product[][price_unit]\" value=\"40.00\"><input type=\"hidden\" name=\"order_number\" value=\""+dateCrypt+"\"><input type=\"submit\" name=\"submit\" value=\"Finalize seu pagamento!!\"></form>" // html body
		}
